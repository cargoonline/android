...
import static de.cargoonline.mobile.push.CommonUtilities.SENDER_ID;
...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    private static final String TAG = "CO GCMIntentService";
 
    public GCMIntentService() {
        super(SENDER_ID);
    }
    
    public static void runIntentInService(Context c, Intent i) {
    	Log.i(TAG, "");
    }
    ...
    private static void generateNotification(Context context, String message) {
        ...
        // deprecated in API level 11 above, but required in API level 8
